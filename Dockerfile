...
RUN apt-get update && apt-get install -y --force-yes python2.7-dev tmux libxml2-dev libxslt1-dev libjpeg-dev libpng-dev libfreetype6-dev build-essential wget pkg-config libpq-dev bzr git vim telnet net-tools unzip netcat-openbsd xvfb libffi-dev lsb-release 
